...
export const networkNodes: NetworkNode[] = [
  { id: 'PERSON-014', label: 'Aarav Mehta', type: 'Person', data: { role: 'Person of Interest' } },
  { id: 'PERSON-021', label: 'Vikram Sharma', type: 'Person', data: { role: 'Person of Interest' } },
  { id: 'PERSON-015', label: 'Nisha Kapoor', type: 'Person', data: { role: 'Person of Interest' } },
  { id: 'PERSON-016', label: 'Ravi Thakur', type: 'Person', data: { role: 'Person of Interest' } },
  { id: 'PERSON-017', label: 'Pooja Bhatia', type: 'Person', data: { role: 'Witness' } },
  { id: 'PERSON-018', label: 'Suresh Yadav', type: 'Person', data: { role: 'Person of Interest' } },
  { id: 'PERSON-019', label: 'Karan Verma', type: 'Person', data: { role: 'Witness' } },
  { id: 'PERSON-020', label: 'Divya Saxena', type: 'Person', data: { role: 'Person of Interest' } },
  ...
  { id: 'ORG-018', label: 'Westline Logistics', type: 'Organization', data: { type: 'Business' } },
  { id: 'ORG-019', label: 'AM Consultancy', type: 'Organization', data: { type: 'Shell Company' } },
  { id: 'VEHICLE-044', label: 'MH-01-AM-4400', type: 'Vehicle', data: { make: 'Mercedes-Benz E-Class' } },
  { id: 'VEHICLE-024', label: 'MH-01-VS-2400', type: 'Vehicle', data: { make: 'Toyota Innova' } },
  { id: 'LOC-087', label: 'Nexus Office, Juhu', type: 'Location', data: {} },
  { id: 'LOC-023', label: 'Pune Office', type: 'Location', data: {} },
  { id: 'LOC-088', label: 'Carter Road Residence', type: 'Location', data: {} },
  { id: 'LOC-089', label: 'Versova Business Centre', type: 'Location', data: {} },
  { id: 'EVIDENCE-044', label: 'FIR Document', type: 'Evidence', data: {} },
  { id: 'EVIDENCE-046', label: 'Bank Transfers', type: 'Evidence', data: {} },
  { id: 'EVIDENCE-049', label: 'Financial Report', type: 'Evidence', data: {} },
  { id: 'TXN-001', label: '₹25L Transfer', type: 'Transaction', data: { amount: 2500000 } },
  { id: 'TXN-006', label: '₹45L Deposit', type: 'Transaction', data: { amount: 4500000 } },
  { id: 'TXN-008', label: '₹56L Transfer', type: 'Transaction', data: { amount: 5600000 } },
];
